						...
						<div class="login-form">
							<form action="<?= base_url('asset/addasset');?>" method="post">
								<div class="form-group">
									...
									<select class="form-control" name="category" id="category" value="<?= set_value('category');?>">
								...
								<div class="form-group">
									...
									<select class="form-control" name="location" id="location" value="<?= set_value('location');?>">
										<option value="">Select..</option>
								...
								<div class="form-group">
									...
									<select class="form-control" name="conditions" id="conditions" value="<?= set_value('conditions');?>" required>
										<option value="">Select..</option>
					...
					<div class="modal-body">
						<div class="login-form">
							<?= form_open_multipart('asset/editasset');?>
								...
								<div class="form-group">
									<label>No Equipment</label>
									<input class="form-control" type="text" name="no_eq" id="no_eq" placeholder="No Equipment" value="<?= $ass->no_eq;?>" readonly>
								</div>
								<div class="form-group">
									<label>No Asset</label>
